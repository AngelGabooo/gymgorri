...
const RegisterCouplePage = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex">
      ...
      {showBlacklistModal && blacklistMatches.length > 0 && (
          ...
          <div className="relative w-full max-w-2xl bg-[#101010] border border-red-500/25 rounded-[26px] shadow-[0_35px_120px_rgba(0,0,0,0.85)] overflow-hidden">
            ...
            <div className="p-7 sm:p-8">
              ...
              <p className="text-gray-400 text-sm mt-2 leading-6">
                Una o ambas personas de esta promoción de pareja tienen antecedentes. La promoción no debe continuar sin revisar la información.
              </p>

              <div className="space-y-3 mt-6 max-h-[330px] overflow-y-auto pr-1">
                {blacklistMatches.map(match => (
                  <div
                    key={`${match.personNumber}-${match.id}`}
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="px-2.5 py-1 rounded-full bg-red-500/10 text-red-400 text-[11px] font-bold">
                        {match.matchedBy?.join(', ') || 'Coincidencia'}
                      </span>
                    </div>

                    <div className="mt-3">
                      <p className="text-gray-500 text-[11px] uppercase tracking-wider">Motivo anterior</p>
                      <p className="text-gray-300 text-sm mt-1">{match.reason || 'Sin motivo registrado'}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              {!canAuthorizeBlacklist && (
                <div className="mt-5 p-4 rounded-xl bg-yellow-500/5 border border-yellow-500/20">
                  <p className="text-yellow-500 text-sm font-semibold">Se requiere autorización</p>
                  <p className="text-gray-400 text-xs mt-1">
                    Solo el dueño o un administrador puede continuar el registro de pareja cuando existe una coincidencia en lista negra.
                  </p>
                </div>
              )}
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-7">
                <button
                  ...
                  className="flex-1 px-5 py-3 bg-[#191919] border border-[#2a2a2a] rounded-xl text-white font-medium"
                >
                  Cancelar registro
                </button>
                ...
                {canAuthorizeBlacklist && (
                  <button
                    ...
                    className="flex-1 px-5 py-3 rounded-xl bg-red-500/15 border border-red-500/25 text-red-400 font-bold"
                  >
